...
$modoRealizar = $modoRealizar ?? ($esPendiente || (($servicio['estado_servicio'] ?? null) === 'material_comprado'));
?>
...
<?php else: ?>
    <?php if ($modoRealizar): ?>
        <div class="alert alert-info">El servicio tiene material comprado. Actualiza el estado cuando el trabajo avance o quede realizado.</div>
    <?php endif; ?>
...
<div class="card-footer">
    <button type="submit" class="btn btn-<?= $modoRealizar ? 'success' : 'primary' ?>"><?= $modoRealizar ? 'Realizar Servicio' : 'Guardar Cambios' ?></button>
